...
//  Blocstagram
//
//  Created by Christopher Allen on 10/16/15.
...
//        }];
        ...
        // as40
        [UIView animateWithDuration:1.0 delay:0 usingSpringWithDamping:0.6f initialSpringVelocity:0.5f options:0 animations:^{
                [self layoutSubviews];
            } completion:nil];
